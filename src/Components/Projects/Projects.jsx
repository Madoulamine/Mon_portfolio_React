...
const projects = [
  {
    ...
    github: 'https://github.com/diallothiernomoussa/Projet_soutenance',
    demo: '#',
    featured: true,
  },
  {
    title: 'DJANGOU (en cours)',
    ...
    tags: ['React', 'Node.js', 'Express', 'Firebase', 'FireStore'],
    github: 'https://github.com/Madoulamine/Djangou',
    demo: '#',
  },
  {
